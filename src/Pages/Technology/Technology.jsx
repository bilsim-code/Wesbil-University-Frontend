  ...
  return (
    <div className="technology">
      <div className="tech-welcome">
        <div className="tech-welcome-content">
          <h2>Welcome to Wesbil School of Technology</h2>
      ...
      <div className="hero-about">
        ...
        <div className="about-body">
          ...
          <div className="about-join-us-tech">
            {/* Use a background image here */}
            <div className="join-us-container-tech">
              <div className="join-us-info-tech">
              <h3>
                <span>Join Us</span>
                <FaArrowRight />
              </h3>
            ...
            <form className="join-us-form-tech">
